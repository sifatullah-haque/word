...
class HomeCleaning extends StatefulWidget {
  @override
  State<HomeCleaning> createState() => _FamilyPageState();
}

class _FamilyPageState extends State<HomeCleaning> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Home Cleaning', style: TextStyle(color: ColorIs.wColor)),
      ),
      body: Column(
